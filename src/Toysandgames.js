...
import { addDatawish } from './wishlistSlice';
...
const One = ({ product }) => {
    ...
    // // const dispatch = useDispatch();
    // const myaddDatawish = (id, name, image, price) => {
    //     let productObj = { id: id, name: name, image: image, price: price, quantity: 1 };
    //     dispatch(addDatawish(productObj));
    // }
            ...
            <>
                <div className="cartData">
                    ...
                    <div className='shop-btn'>
                        <a href='login'><button onClick={() => { mydataAdd(key.id, key.name, key.image, key.price) }}>
                            Add To Cart
                        </button></a>
                        ...
                        {/* <button onClick={() => { myaddDatawish(key.id, key.name, key.image, key.price) }} id='likebtn'>
                            <i class='bx bxs-heart'></i>
                        </button> */}
                    </div>
                </div>
        ...
        <>
            <div className="toygames">
                <div className="sidenav1">
                    ...
                    <button id='click' onClick={applyFilters}>Apply Filters</button>
                    <button id='click' onClick={resetFilters}>Reset Filters</button>
